...
import { Button, Modal, TextArea, Form, Dropdown } from 'semantic-ui-react'
...
class ModalExampleSize extends Component {
    ...
    render() {
        ...
        return (
            <Modal size="tiny" open={open} onClose={this.props.close}>
                <Modal.Header>Send a mail</Modal.Header>
                <Modal.Content>
                    <Form>
                        <Form.Field>
                            <Dropdown
                        ...
                        <Form.Field>
                            <TextArea name="message" value={this.state.message} onChange={this.handleChange} style={{ resize: 'none' }} placeholder='Tell us more' />
                        </Form.Field>
                    </Form>
                </Modal.Content>
                <Modal.Actions>
                    {this.state.result ? <b style={{color: 'green'}}>{this.state.result}</b> : null}
                    <Button negative onClick={this.props.close}>Cancel</Button>
                    <Button loading={this.state.loading} positive icon='checkmark' labelPosition='right' onClick={this.handleSendMessage} content='Send' />
                </Modal.Actions>
            </Modal>
        )
    }
